...
public class z376WiggleSubsequence
{
    public static int wiggleMaxLength(int[] nums) 
    {
    	...
    	for(int i=1 ; i<tmp.size()-1 ; ++i)
    		if( (tmp.get(i)-tmp.get(i-1))*(tmp.get(i+1)-tmp.get(i))>0 )
    			--n;
    	return n;
